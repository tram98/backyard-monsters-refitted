package com.monsters.maproom_inferno.views
{
   ...
   public class MapView extends MapView_CLIP
   {
      ...
      public function Setup() : void
      {
         ...
         this.bounds = new Rectangle(0,0,-_MAPSIZE.width,-_MAPSIZE.height);
         ...
         this.miniMap.mapSize = new Rectangle(this.displayBounds.x,this.displayBounds.y,_MAPSIZE.width,_MAPSIZE.height);
         this.miniMap.x = 560;
         this.miniMap.y = 8;
         this.miniMap.Setup();
