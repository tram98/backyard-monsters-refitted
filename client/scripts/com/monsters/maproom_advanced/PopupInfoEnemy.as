package com.monsters.maproom_advanced
{
   ...
   internal class PopupInfoEnemy extends PopupInfoEnemy_CLIP
   {
      ...
      private function TakeOverConfirm() : void
      {
         ...
         var takeoverVars:Array = [["baseid",this._cell._baseID],["resources",JsonUtil.encode({
      ...
      {
         var _loc1_:String = "";
         _loc1_ = "X:" + this._cell.X + " Y:" + this._cell.Y + "<br>_base:" + this._cell._base + "<br>_height:" + this._cell._height + "<br>_water:" + this._cell._water + "<br>_mine:" + this._cell._mine + "<br>_flinger:" + this._cell._flingerRange.Get() + "<br>_catapult:" + this._cell._catapult + "<br>_userID:" + this._cell._userID + "<br>_truce:" + this._cell._truce + "<br>_name:" + this._cell._name + "<br>_protected:" + this._cell._protected + "<br>_resources:" + JsonUtil.encode(this._cell._resources) + "<br>_ticks:" + JsonUtil.encode(this._cell._ticks) + "<br>_monsters:" + JsonUtil.encode(this._cell._monsters);
         if(this._cell._monsterData)
         {
            _loc1_ += "<br>_monsterData:" + JsonUtil.encode(this._cell._monsterData);
            _loc1_ += "<br>_monsterData.saved:" + JsonUtil.encode(this._cell._monsterData.saved);
            _loc1_ += "<br>_monsterData.h:" + JsonUtil.encode(this._cell._monsterData.h);
